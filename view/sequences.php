...
if ($certificate_id) {
	trainingpath_trigger_item_event('theme_viewed', $course, $cm, $learningpath, $certificate);
} else {
	trainingpath_trigger_item_event('phase_viewed', $course, $cm, $learningpath, $batch);
}
