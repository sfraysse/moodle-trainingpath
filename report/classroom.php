...
// Page URL
$url = new moodle_url('/mod/trainingpath/report/classroom.php', array('cmid'=>$cmid, 'group_id'=>$groupId, 'activity_id'=>$activityId, 'eval_only'=>$evalOnly));
$PAGE->set_url($url);
...
require_once('classroom_form.php');
$mform = new mform_classroom(null, array('cmid'=>$cmid, 'group_id'=>$groupId, 'activity_id'=>$activityId, 'session'=>$session, 'eval_only'=>$evalOnly, 'duration'=>$activity->duration));
