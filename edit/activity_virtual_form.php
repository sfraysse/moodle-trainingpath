...
class mform_activity_virtual extends moodleform {
    ...
    public function definition() {
		...
		// Duration
		if (!$complementary) {
			$error = get_string('virtual_duration_error', 'trainingpath');
			$mform->addElement('text', 'duration', get_string('virtual_duration', 'trainingpath'), 'maxlength="3" size="3"');
			...
			$mform->addHelpButton('duration', 'virtual_duration', 'trainingpath');
		}
