...
$parentId = required_param('parent_id', PARAM_INT); 
...
trainingpath_json_response_edit_items($cmid, $parentId, EATPL_ITEM_TYPE_SEQUENCE, 'sequence', EATPL_ITEM_TYPE_ACTIVITY, 'activity', null, null, null, $via);
