...
// Page URL
$url = new moodle_url('/mod/trainingpath/edit/schedules.php', array('cmid'=>$cmid));
$PAGE->set_url($url);
...
echo trainingpath_edit_get_schedules($cmid);


//------------------------------------------- Buttons -------------------------------------------//

$schedule_url = (new moodle_url('/mod/trainingpath/edit/schedule.php', array('cmid'=>$cmid)))->out();
echo trainingpath_edit_get_commands(array(
    'add'=>array('class'=>'primary', 'label'=>get_string('add_schedule', 'trainingpath'), 'href'=>$schedule_url)
));
