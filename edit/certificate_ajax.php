...
trainingpath_json_response_edit_items($cmid, $topitem->id, EATPL_ITEM_TYPE_PATH, 'path', EATPL_ITEM_TYPE_CERTIFICATE, 'certificate', EATPL_ITEM_TYPE_SEQUENCE, 'sequences');
